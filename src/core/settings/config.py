...
class Settings(BaseSettings):
    ...
    # RAG Configuration
    # =============================================================================
    retrieval_k_value: int = Field(default=50, description="Number of chunks to retrieve for RAG")
    max_retrieval_chunks: int = Field(default=100, description="Maximum number of chunks that can be retrieved")
